...
$nd_travel_typology_id = get_the_ID();
$nd_travel_typology_title = get_the_title();
...
if(have_posts()) :
	while(have_posts()) : the_post();
			...
			$nd_travel_cpt_2_packages_section = '';
			$nd_travel_cpt_2_agent_section = '';
			$nd_travel_cpt_2_contact_section = '';

			//get number packages number
			$nd_travel_number_packages = $nd_travel_number_packages + nd_travel_get_number_posts('nd_travel_cpt_1','nd_travel_meta_box_typologies',$nd_travel_typology_id);
			...
			$nd_travel_cpt_2_packages_section .= '
    			...
    			<div id="nd_travel_single_cpt_2_info_packages" class="nd_travel_section nd_travel_position_relative ">
			        ...
			        <img style="background-color:'.$nd_travel_meta_box_cpt_2_color.';" alt="" class="nd_travel_position_absolute nd_travel_bg_greydark nd_travel_left_0 nd_travel_padding_10 nd_travel_top_0" width="25" src="'.plugins_url().'/nd-travel/assets/img/icons/icon-planet-earth-white.png">
			        ...
			        <div class="nd_travel_section nd_travel_box_sizing_border_box nd_travel_padding_left_60"> 
			            ...
			            <p class="nd_options_second_font ">'.$nd_travel_number_packages.' '.__('Tours','nd-travel').' '.__('in','nd-travel').' '.$nd_travel_typology_title.'</p> 
    		...
    		//country section
    		if ( $nd_travel_meta_box_agent_title_cpt_2 != '' ) {

		    	$nd_travel_cpt_2_agent_section .= '

	    			<div id="nd_travel_single_cpt_2_info_agent" class="nd_travel_section nd_travel_position_relative nd_travel_margin_top_20">

				        <img style="background-color:'.$nd_travel_meta_box_cpt_2_color.';" alt="" class="nd_travel_position_absolute nd_travel_left_0 nd_travel_padding_10 nd_travel_top_0" width="25" src="'.plugins_url().'/nd-travel/assets/img/icons/icon-user-white.png">

				        <div class="nd_travel_section nd_travel_box_sizing_border_box nd_travel_padding_left_60"> 
				            
				            <h3 class="nd_options_second_font nd_travel_font_weight_normal  nd_travel_font_size_14 nd_travel_margin_top_5">'.$nd_travel_meta_box_agent_title_cpt_2.'</h3> 
				            <p class="nd_options_second_font ">'.$nd_travel_meta_box_agent_descr_cpt_2.'</p> 
    		...
    		//contact section
    		if ( $nd_travel_meta_box_contact_title_cpt_2 != '' ) {

		    	$nd_travel_cpt_2_contact_section .= '

	    			<div id="nd_travel_single_cpt_2_info_contact" class="nd_travel_section nd_travel_position_relative nd_travel_margin_top_20">

				        <img style="background-color:'.$nd_travel_meta_box_cpt_2_color.';" alt="" class="nd_travel_position_absolute nd_travel_left_0 nd_travel_padding_10 nd_travel_top_0" width="25" src="'.plugins_url().'/nd-travel/assets/img/icons/icon-message-white.svg">

				        <div class="nd_travel_section nd_travel_box_sizing_border_box nd_travel_padding_left_60"> 
				            
				            <h3 class="nd_options_second_font nd_travel_font_weight_normal  nd_travel_font_size_14 nd_travel_margin_top_5">'.$nd_travel_meta_box_contact_title_cpt_2.'</h3> 
				            <p class="nd_options_second_font ">'.$nd_travel_meta_box_contact_descr_cpt_2.'</p> 
			...
			<div id="nd_travel_single_cpt_2_all_packages" class="nd_travel_width_100_percentage nd_travel_float_left">
			    ...
			    <h1 id="nd_travel_single_cpt_2_all_packages_title" class="nd_travel_text_align_center nd_travel_font_weight_normal">'.__('PACKAGES','nd-travel').'</h1>
			    ...
			    '.do_shortcode('[nd_travel_packages_pg nd_travel_width="nd_travel_width_33_percentage nd_travel_float_left" nd_travel_typologies="'.$nd_travel_typology_id.'" nd_travel_image_size="large" nd_travel_qnt="-1"]').'
