    ...
    $str .= '
      ...
      <script type="text/javascript">
        ...
        .nd_travel_search_filter_layout_list { background-image:url('.plugins_url().'/nd-travel/assets/img/icons/icon-list-grey.svg); }
      	...
      	<div id="nd_travel_vc_order" class="nd_travel_section '.$nd_travel_class.' ">

      		<div id="nd_travel_search_results_order_options" class="nd_travel_section nd_travel_padding_10_0 nd_travel_box_sizing_border_box nd_travel_bg_greydark nd_travel_text_align_center">
            	...
            	<div class="nd_travel_section nd_travel_position_relative nd_travel_line_height_0">
					...
					<ul id="nd_travel_search_filter_options" class="nd_travel_list_style_none nd_travel_display_inline_block nd_travel_padding_0 nd_travel_margin_0">
					  <li id="nd_travel_vc_order_price" class="nd_travel_display_inline_block nd_travel_position_relative nd_travel_padding_20 nd_travel_padding_bottom_15 nd_travel_margin_0 nd_travel_float_left">
					      
					      <p class="nd_travel_font_size_12 nd_travel_padding_bottom_5 nd_travel_letter_spacing_2 nd_travel_text_transform_uppercase nd_travel_float_left">'.__('Price','nd-travel').'</p>
					  ...
					  <li id="nd_travel_vc_order_size" class="nd_travel_display_inline_block nd_travel_position_relative nd_travel_padding_20 nd_travel_padding_bottom_15 nd_travel_margin_0 nd_travel_float_left">

					      <p class="nd_travel_font_size_12 nd_travel_padding_bottom_5 nd_travel_letter_spacing_2 nd_travel_text_transform_uppercase nd_travel_float_left">'.__('Name','nd-travel').'</p> 
					      <img alt="" class="nd_travel_margin_left_10 nd_travel_float_left" width="10" src="'.plugins_url().'/nd-travel/assets/img/icons/icon-down-arrow-white.svg">
