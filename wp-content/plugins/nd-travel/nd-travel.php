...
function nd_travel_scripts() {
  ...
  //basic css plugin
  wp_enqueue_style( 'nd_travel_style', plugins_url() . '/nd-travel/assets/css/style.css' );
...
function nd_travel_admin_style() {
  ...
  wp_enqueue_style( 'nd_travel_admin_style', plugins_url() . '/nd-travel/assets/css/admin-style.css', array(), false, false );
