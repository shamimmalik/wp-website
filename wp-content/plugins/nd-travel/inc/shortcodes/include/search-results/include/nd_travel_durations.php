...
$nd_travel_shortcode_left_content .= '
        ...
        <!--START durations-->
        <div class=" '.$nd_travel_durations_class.' nd_travel_width_100_percentage nd_travel_float_left nd_travel_box_sizing_border_box">
              ...
              <div class="nd_travel_section nd_travel_position_relative nd_travel_padding_30 nd_travel_padding_30_15_all_iphone nd_travel_box_sizing_border_box">
                    <h3 class="nd_travel_font_weight_normal nd_travel_font_size_16">'.__('Durations','nd-travel').' :</h3>
                    <img class="nd_travel_toogle_durations_open_content nd_travel_position_absolute nd_travel_right_30 nd_travel_top_35 nd_travel_cursor_pointer" alt="" width="12" src="'.plugins_url().'/nd-travel/assets/img/icons/icon-down-arrow-grey.svg">
                    <img style="transform: rotate(180deg);" class="nd_travel_toogle_durations_close_content nd_travel_display_none nd_travel_position_absolute nd_travel_right_30 nd_travel_top_35 nd_travel_cursor_pointer" alt="" width="12" src="'.plugins_url().'/nd-travel/assets/img/icons/icon-down-arrow-grey.svg">
                </div>
        ...
        ';
    		...
    		//get tax
    		$nd_travel_the_tax = get_taxonomy('nd_travel_cpt_1_tax_1');
          ...
          <div class="nd_travel_toogle_durations_content nd_travel_padding_0_30 nd_travel_section nd_travel_display_none  nd_travel_margin_top_10_negative nd_travel_box_sizing_border_box">';
    			...
    			foreach ($nd_travel_terms as $nd_travel_term) {
    		        ...
    		        <p class="nd_travel_width_50_percentage nd_travel_width_100_percentage_all_iphone nd_travel_float_left nd_travel_margin_0">
    		          <input class="nd_travel_checkbox_duration nd_travel_width_25 nd_travel_margin_0 nd_travel_padding_0 nd_travel_margin_top_8" name="nd_travel_duration_id_'.$nd_travel_term->term_id.'" '; if( $nd_travel_cpt_1_tax_1_id == $nd_travel_term->term_id ){ $nd_travel_shortcode_left_content .='checked'; } $nd_travel_shortcode_left_content .=' type="checkbox" value="'.$nd_travel_term->term_id.',">
    		            '.$nd_travel_term->name.'
    		        </p>'; 
            ...
            <div class="nd_travel_section nd_travel_height_20"></div>
      		...
      		$nd_travel_shortcode_left_content .= '
      		<input type="hidden" id="nd_travel_archive_form_durations" name="nd_travel_archive_form_durations" value="'.$nd_travel_cpt_1_tax_1_id_value.'">
    	    ...
    	    <script type="text/javascript">
    	      ...
    	      jQuery(document).ready(function() {
    	        ...
    	        jQuery( function ( $ ) {
                    ...
                    if ( $nd_travel_cpt_1_tax_1_id_value != '' ) {
                      $nd_travel_shortcode_left_content .= '$( ".nd_travel_toogle_durations_open_content" ).trigger( "click" );';
                    }
