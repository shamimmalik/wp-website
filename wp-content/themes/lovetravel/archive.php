...
<div id="nicdark_header_img_archive" class="nicdark_section nicdark_border_bottom_1_solid_grey">
    ...
    <div class="nicdark_container nicdark_clearfix">
    	...
    	<div class="nicdark_grid_12">
    		...
    		<?php if (is_category()): ?>
				<h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone"><?php esc_html_e('Category','lovetravel'); ?></h1>
				<div class="nicdark_section nicdark_height_10"></div>
				<h4 class="nicdark_text_transform_uppercase nicdark_color_grey  nicdark_second_font"><?php single_cat_title(); ?></h4>
			<?php elseif (is_tag()): ?>
				<h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone"><?php esc_html_e('Tag','lovetravel'); ?></h1>
				<div class="nicdark_section nicdark_height_10"></div>
				<h4 class="nicdark_text_transform_uppercase nicdark_color_grey  nicdark_second_font  "><?php single_tag_title() ?></h4>
			<?php elseif (is_month()): ?>
				<h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone"><?php esc_html_e('Archive for','lovetravel'); ?></h1>
				<div class="nicdark_section nicdark_height_10"></div>
				<h4 class="nicdark_text_transform_uppercase nicdark_color_grey  nicdark_second_font  "><?php single_month_title(' '); ?></h4>
			<?php elseif (is_author()): ?>
				<h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone"><?php esc_html_e('Author','lovetravel'); ?></h1>
				<div class="nicdark_section nicdark_height_10"></div>
				<h4 class="nicdark_text_transform_uppercase nicdark_color_grey  nicdark_second_font  "><?php the_author(); ?></h4>
			<?php elseif (is_search()): ?>
				<h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone"><?php esc_html_e('Search for','lovetravel'); ?></h1>
				<div class="nicdark_section nicdark_height_10"></div>
				<h4 class="nicdark_text_transform_uppercase nicdark_color_grey  nicdark_second_font  ">" <?php the_search_query(); ?> "</h4>
			<?php else: ?>
				<h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone"><?php esc_html_e('Archive','lovetravel'); ?></h1>
			<?php endif ?>
    	...
    	<?php } ?>
							...
							<div class="nicdark_section nicdark_float_left nicdark_padding_30 nicdark_padding_15_responsive nicdark_border_1_solid_grey nicdark_box_sizing_border_box">
								...
								<h2>
									<a class="nicdark_color_greydark nicdark_first_font" href="<?php the_permalink(); ?>">
										<?php the_title(); ?>
										<?php if ( has_post_format( 'video' )) { esc_html_e(' - Video','lovetravel'); } ?>
									</a>
								</h2>
								...
								<div class="nicdark_section nicdark_box_sizing_border_box nicdark_archive_info_post">
									...
									<div class="nicdark_float_left nicdark_width_100_percentage_all_iphone nicdark_margin_top_5_all_iphone">
										<p class="nicdark_color_grey nicdark_font_size_13 nicdark_line_height_18 nicdark_second_font">
											<span class="nicdark_color_greydark"><strong><?php esc_html_e('DATE','lovetravel'); ?></strong></span> : 
									...
									<div class="nicdark_float_left nicdark_width_100_percentage_all_iphone nicdark_margin_top_5_all_iphone">
										<p class="nicdark_color_grey nicdark_font_size_13 nicdark_line_height_18 nicdark_second_font">
											<span class="nicdark_margin_left_10 nicdark_margin_left_0_all_iphone nicdark_color_greydark"><strong><?php esc_html_e('AUTHOR','lovetravel'); ?></strong></span> : 
									...
									<div class="nicdark_float_left nicdark_width_100_percentage_all_iphone nicdark_margin_top_5_all_iphone">
										<p class="nicdark_color_grey nicdark_font_size_13 nicdark_line_height_18 nicdark_second_font">
											<span class="nicdark_margin_left_10 nicdark_margin_left_0_all_iphone nicdark_archive_info_post_comment nicdark_color_greydark"><strong><?php esc_html_e('COMMENTS','lovetravel'); ?></strong></span> : 
			...
			<div class="nicdark_section">
		    	...
		    	the_posts_pagination( array(
					...
					'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'lovetravel' ) . ' </span>',
				) );
